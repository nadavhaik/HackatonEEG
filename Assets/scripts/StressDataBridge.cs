...
public class StressData    
{
    ...
    public double temp;
    public void SetStressTemp(double gauge)
    {
        temp = gauge;
    }
    ...
    public double getStressLevel(){
        // if (Time.realtimeSinceStartup - last_time_updated_stress_level > 1f){
        //     last_time_updated_stress_level = Time.realtimeSinceStartup;
        //     last_stress_level = temp;
        // }
        // double delta = Time.realtimeSinceStartup - last_time_updated_stress_level; // is between [0,1]
        // temp = (temp - last_stress_level) * delta + last_stress_level;
